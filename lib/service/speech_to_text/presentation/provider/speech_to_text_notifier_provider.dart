...
import 'package:viminsk_assistent/service/text_to_speech/domain/provider/text_speech_provider.dart';
...
final speechToTextNotifierProvider =
  ...
  final textSpeechRepository = ref.read(textSpeechRepositoryProvider);
